 ...
 */
class CustomerRepository extends EntityRepository implements UserEmaileableInterface, UserLoaderInterface {
	/**
	...
	public function loadUserByUsername($username) {
		return $this->createQueryBuilder('u')
			->where('u.guest = :guest AND u.email = :email AND u.enabled = :enabled')
