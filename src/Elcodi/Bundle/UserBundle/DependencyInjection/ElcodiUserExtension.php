...
class ElcodiUserExtension extends AbstractExtension implements EntitiesOverridableExtensionInterface {
	...
	protected function getParametrizationValues(array $config) {
		return [
			...
			'elcodi.entity.customer_category.class' => $config['mapping']['customer_category']['class'],
			'elcodi.entity.customer_category.mapping_file' => $config['mapping']['customer_category']['mapping_file'],
			'elcodi.entity.customer_category.manager' => $config['mapping']['customer_category']['manager'],
			'elcodi.entity.customer_category.enabled' => $config['mapping']['customer_category']['enabled'],
		];
	}
	...
	public function getEntitiesOverrides() {
		return [
			...
			'Elcodi\Component\User\Entity\Interfaces\CustomerCategoryInterface' => 'elcodi.entity.customer_category.class',
		];
	}
